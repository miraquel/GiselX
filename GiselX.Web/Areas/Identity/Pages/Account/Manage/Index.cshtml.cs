...
namespace GiselX.Web.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = setUserNameResult.Succeeded ? "Your profile has been updated" : "Unexpected error when trying to update your profile.";
